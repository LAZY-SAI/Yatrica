...
const AdminDash = () => {
  ...
  const activity = [
    ...
    { id: 2, name: "New trips created", numbers:null, percent: "+3.5%" },
    { id: 3, name: "Bookings linked", numbers: null, percent: "-1.9%" },
    { id: 4, name: "Reports & flags", numbers: null, percent: "-0.4%" },
    { id: 5, name: "System Quota", numbers: null, percent: "" },
    {
      id: 6,
      name: "Pending Flag",
